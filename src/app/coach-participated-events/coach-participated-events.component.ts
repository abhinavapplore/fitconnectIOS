...
@Component({
  ...
  templateUrl: './coach-participated-events.component.html',
  styleUrls: ['./coach-participated-events.component.scss'],
})
export class CoachParticipatedEventsComponent implements OnInit {
