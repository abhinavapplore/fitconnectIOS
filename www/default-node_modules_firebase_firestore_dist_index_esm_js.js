...
/* harmony export */   "writeBatch": () => (/* reexport safe */ _firebase_firestore__WEBPACK_IMPORTED_MODULE_0__.writeBatch)
/* harmony export */ });
/* harmony import */ var _firebase_firestore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/firestore */ 85545);
...
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/util */ 94766);
...
/* harmony export */ });
/* harmony import */ var _Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ 62783);
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/app */ 37904);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 59633);
/* harmony import */ var _firebase_logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/logger */ 1088);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 94766);
/* harmony import */ var _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/webchannel-wrapper */ 57076);
...
const D = new _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.Logger("@firebase/firestore"); // Helper methods are needed because variables can't be exported as read/write
...
function F(t = "Unexpected state") {
  ...
  const e = `FIRESTORE (${S}) INTERNAL ASSERTION FAILED: ` + t; // NOTE: We don't use FirestoreError here because these are internal failures
...
class G {
  ...
  start(t, e) {
    ...
    const r = () => {
      const e = i;
      t.enqueueRetryable( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield e.promise, yield s(_this.currentUser);
      }));
    },
          o = t => {
      x("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.auth.addAuthTokenListener(this.o), r();
    };
  ...
  getToken() {
    ...
    this.i !== t ? (x("FirebaseCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e ? (M("string" == typeof e.accessToken), new j(e.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
...
class ct extends at {
  ...
  static fromString(...t) {
    ...
    for (const n of t) {
      if (n.indexOf("//") >= 0) throw new q(U.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`); // Strip leading and traling slashed.
...
class ht extends at {
  ...
  canonicalString() {
    return this.toArray().map(t => (t = t.replace(/\\/g, "\\\\").replace(/`/g, "\\`"), ht.isValidIdentifier(t) || (t = "`" + t + "`"), t)).join(".");
  }
...
function Ct(t) {
  ...
  }(t.timestampValue) : "stringValue" in t ? t.stringValue : "bytesValue" in t ? gt(t.bytesValue).toBase64() : "referenceValue" in t ? (n = t.referenceValue, Rt.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function (t) {
    let e = "[",
        n = !0;
...
class Lt {
  ...
  field(t) {
    if (t.isEmpty()) return this.value;
    {
      ...
      for (let n = 0; n < t.length - 1; ++n) if (e = (e.mapValue.fields || {})[t.get(n)], !Ft(e)) return null;
...
function jt(t) {
  ...
  if (null === e.A) {
    ...
    null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map(t => Ht(t)).join(","), t += "|ob:", t += e.orderBy.map(t => function (t) {
      // TODO(b/29183165): Make this collision robust.
      return t.field.canonicalString() + t.dir;
    }(t)).join(","), Tt(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", t += re(e.startAt)), e.endAt && (t += "|ub:", t += re(e.endAt)), e.A = t;
  }
...
function Qt(t) {
  ...
  }).join(", ")}]`), Tt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map(t => function (t) {
    return `${t.field.canonicalString()} (${t.dir})`;
  }(t)).join(", ")}]`), t.startAt && (e += ", startAt: " + re(t.startAt)), t.endAt && (e += ", endAt: " + re(t.endAt)), `Target(${e})`;
}
...
function Wt(t, e) {
  ...
  for (let i = 0; i < t.filters.length; i++) if (n = t.filters[i], s = e.filters[i], n.op !== s.op || !n.field.isEqual(s.field) || !Pt(n.value, s.value)) return !1;
...
function ye(t) {
  ...
  if (null === e.V) {
    ...
    if (null !== t && null === n) // In order to implicitly add key ordering, we must also add the
      ...
      t.isKeyField() || e.V.push(new oe(t)), e.V.push(new oe(ht.keyField(), "asc"
      /* ASCENDING */
      ));else {
      let t = !1;
...
function pe(t) {
  ...
  === e.limitType) e.S = Kt(e.path, e.collectionGroup, ye(e), e.filters, e.limit, e.startAt, e.endAt);else {
    ...
    const n = e.endAt ? new ie(e.endAt.position, !e.endAt.before) : null,
          s = e.startAt ? new ie(e.startAt.position, !e.startAt.before) : null; // Now return as a LimitType.First query.
...
function ze(t, e, n) {
  t instanceof Ze ? function (t, e, n) {
    ...
    const s = nn(t.fieldTransforms, e, n.transformResults),
          i = e.data;
...
function He(t, e, n) {
  ...
  */
  (t, e, n) : t instanceof tn ? function (t, e, n) {
    ...
    const s = sn(t.fieldTransforms, n, e),
          i = e.data;
...
wn.EMPTY = new // Represents an empty node (a leaf node in the Red-Black Tree).
class {
  constructor() {
    this.size = 0;
  }
...
class xn {
  ...
  _t(t) {
    ...
    let n = Rn(); // We extract the set of limbo-only document updates as the GC logic
...
function zn(t) {
  const e = jn(t); // In v1beta1 queries for collections at the root did not have a trailing
...
function ts(t, e) {
  ...
  if ("targetChange" in e) {
    ...
    */
    ...
    const i = Wn(t, s.document.name),
          r = qn(s.document.updateTime),
          o = new Lt({
      mapValue: {
        fields: s.document.fields
      }
    }),
          a = Ut.newFoundDocument(i, r, o),
          c = s.targetIds || [],
    ...
    s.document;
    const i = Wn(t, s.document),
          r = s.readTime ? qn(s.readTime) : st.min(),
          o = Ut.newNoDocument(i, r),
...
const Ls = [...[...[...[...[bs.store, Ps.store, vs.store, Ds.store, Ns.store, Rs.store, ks.store, xs.store], Os.store], Cs.store], $s.store], Fs.store, Ms.store],
...
class js {
  ...
  constructor(t, e, n) {
    ...
    12.2 === js.Rt((0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getUA)()) && k("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  ...
  Dt(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this2.db || (x("SimpleDb", "Opening database:", _this2.name), _this2.db = yield new Promise((e, n) => {
        ...
        s.onsuccess = t => {
          ...
          x("SimpleDb", 'Database "' + _this2.name + '" requires upgrade from version:', t.oldVersion);
          const e = t.target.result;

          _this2.At.Ct(e, s.transaction, t.oldVersion, _this2.version).next(() => {
            x("SimpleDb", "Database upgrade to version " + _this2.version + " complete");
          });
        };
      })), _this2.Nt && (_this2.db.onversionchange = t => _this2.Nt(t)), _this2.db;
    })();
  }
  ...
  runTransaction(t, e, n, s) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (;;) {
        ...
        try {
          _this3.db = yield _this3.Dt(t);
          const e = Ks.open(_this3.db, t, i ? "readonly" : "readwrite", n),
                r = s(e).catch(t => ( // Abort the transaction if there was an error.
          e.abort(t), qs.reject(t))).toPromise(); // As noted above, errors are propagated by aborting the transaction. So
          ...
          if (x("SimpleDb", "Transaction failed with error:", t.message, "Retrying:", e), _this3.close(), !e) return Promise.reject(t);
        }
      }
    })();
  }
...
class zs {
  ...
  get(t) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return Hs(this.store.get(t)).next(e => ( // Normalize nonexistence to null.
...
function Ys(t) {
  const e = js.Rt((0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getUA)());
...
class ti {
  ...
  applyToLocalView(t) {
    ...
    for (const e of this.baseMutations) e.key.isEqual(t.key) && He(e, t, this.localWriteTime); // Second, apply all user-provided mutations.
...
function ii(t, e) {
  ...
  if (e.noDocument) {
    const t = Rt.fromSegments(e.noDocument.path),
          n = ui(e.noDocument.readTime),
          s = Ut.newNoDocument(t, n);
    return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
  }

  if (e.unknownDocument) {
    const t = Rt.fromSegments(e.unknownDocument.path),
          n = ui(e.unknownDocument.version);
...
function hi(t, e) {
  const n = (e.baseMutations || []).map(e => ns(t.Wt, e)); // Squash old transform mutations into existing patch or set mutations.
  ...
  const s = e.mutations.map(e => ns(t.Wt, e)),
...
class bi {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return r.add({}).next(o => {
      ...
      const a = new ti(o, e, n, s),
            c = function (t, e, n) {
        const s = n.baseMutations.map(e => es(t.Wt, e)),
              i = n.mutations.map(e => es(t.Wt, e));
        return new Ps(e, n.batchId, n.localWriteTime.toMillis(), s, i);
      }(this.N, this.userId, a),
            u = [];
  ...
  getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    const n = vs.prefixForPath(this.userId, e.path),
  ...
  getAllMutationBatchesAffectingDocumentKeys(t, e) {
    ...
    const s = [];
    return e.forEach(e => {
      const i = vs.prefixForPath(this.userId, e.path),
  ...
  performConsistencyCheck(t) {
    return this.checkEmpty(t).next(e => {
      ...
      const n = IDBKeyRange.lowerBound(vs.prefixForUser(this.userId)),
            s = [];
      return Vi(t).Kt({
        range: n
      }, (t, e, n) => {
...
function Pi(t, e, n) {
  const s = vs.prefixForPath(e, n.path),
        i = s[1],
...
class Ci {
  ...
  addTargetData(t, e) {
    return this.ae(t, e).next(() => this.re(t).next(n => (n.targetCount += 1, this.ce(e, n), this.oe(t, n))));
  }
  ...
  removeTargetData(t, e) {
    return this.removeMatchingKeysForTargetId(t, e.targetId).next(() => Ni(t).delete(e.targetId)).next(() => this.re(t)).next(e => (M(e.targetCount > 0), e.targetCount -= 1, this.oe(t, e)));
  }
  /**
  ...
  getTargetData(t, e) {
    ...
    return Ni(t).Kt({
      ...
      const r = li(n); // After finding a potential match, check that the target is
...
function _$i() {
  _$i = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
...
class Mi {
  ...
  _e(t) {
    ...
    x("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.we = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection"
    /* LruGarbageCollection */
    , e, /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this4.we = null, _this4.de = !0;

      try {
        yield t.collectGarbage(_this4.garbageCollector);
      } catch (t) {
        Gs(t) ? x("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : yield $i(t);
      }
...
class Li {
  ...
  pe(t, e) {
    ...
    e > this.params.maximumSequenceNumbersToCollect ? (x("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${e}`), s = this.params.maximumSequenceNumbersToCollect) : s = e, r = Date.now(), this.nthSequenceNumber(t, s))).next(s => (n = s, o = Date.now(), this.removeTargets(t, n, e))).next(e => (i = e, c = Date.now(), this.removeOrphanedDocuments(t, n))).next(t => {
      if (u = Date.now(), C() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.LogLevel.DEBUG) {
...
class ji {
  ...
  Pe(t, e, n) {
    ...
    return Gi(t).Kt({
      ...
      const o = Rt.fromSegments(t); // Go through keys not found in cache.
  ...
  Re(t, e) {
    if (e) {
      const t = ii(this.N, e); // Whether the document is a sentinel removal and should only be used in the
...
class Qi extends Ki {
   ...
   */
  constructor(t, e) {
    super(), this.Se = t, this.trackRemovals = e, // A map of document sizes prior to applying the changes in this buffer.
  ...
  applyChanges(t) {
    const e = [];
    let n = 0,
        s = new _n((t, e) => Z(t.canonicalString(), e.canonicalString()));
...
class Hi {
  ...
  Ct(t, e, n, s) {
    ...
    */
    ...
    }(t), this.Ne(i)))), n < 7 && s >= 7 && (r = r.next(() => this.xe(i))), n < 8 && s >= 8 && (r = r.next(() => this.ke(t, i))), n < 9 && s >= 9 && (r = r.next(() => {
...
class Xi {
  ...
  nn(t) {
    ...
    return this.Qe = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
  ...
  setDatabaseDeletedListener(t) {
    this.Ge.xt( /*#__PURE__*/function () {
      var _ref4 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
  ...
  setNetworkEnabled(t) {
    ...
    this.Oe.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this6.started && (yield _this6.Xe());
    })));
  }
  /**
  ...
  hn() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this7.isPrimary && !_this7.ln(_this7.je, 18e5)) {
        ...
        if (_this7.Ye) for (const e of t) _this7.Ye.removeItem(_this7.dn(e.clientId));
      }
    })();
  }
  /**
  ...
  en() {
    ...
    , 4e3, () => this.Xe().then(() => this.hn()).then(() => this.en()));
  }
  ...
  rn(t) {
    ...
    }).next(t => (this.isPrimary !== t && x("IndexedDbPersistence", `Client ${t ? "is" : "is not"} eligible for a primary lease.`), t));
  }
  ...
  shutdown() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this8.Be = !1, _this8._n(), _this8.Ke && (_this8.Ke.cancel(), _this8.Ke = null), _this8.mn(), _this8.gn(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
      // has obtained the primary lease.
      yield _this8.Ge.runTransaction("shutdown", "readwrite", [Rs.store, Os.store], t => {
        const e = new Xs(t, J.T);
        return _this8.on(e).next(() => _this8.un(e));
      }), _this8.Ge.close(), // Remove the entry marking the client as zombied from LocalStorage since
  ...
  runTransaction(t, e, n) {
    ...
    let i; // Do all transactions as readwrite against all object stores, since we
    // are the only reader/writer.

    return this.Ge.runTransaction(t, s, Ls, s => (i = new Xs(s, this.Le ? this.Le.next() : J.T), "readwrite-primary" === e ? this.sn(i).next(t => !!t || this.rn(i)).next(e => {
      if (!e) throw k(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, this.Oe.enqueueRetryable(() => this.Qe(!1)), new q(U.FAILED_PRECONDITION, Bs);
      return n(i);
    }).next(t => this.an(i).next(() => t)) : this.En(i).next(() => n(i)))).then(t => (i.raiseOnCommittedEvent(), t));
  }
  /**
  ...
  on(t) {
    const e = Zi(t);
    return e.get(Rs.key).next(t => this.cn(t) ? (x("IndexedDbPersistence", "Releasing primary lease."), e.delete(Rs.key)) : qs.resolve());
  }
  ...
  tn() {
    ...
    "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Ue = () => {
      ...
      this._n(), (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.isSafari)() && navigator.appVersion.match("Version/14") && // On Safari 14, we do not run any cleanup actions as it might trigger
      // a bug that prevents Safari from re-opening IndexedDB during the
      // next page load.
      // See https://bugs.webkit.org/show_bug.cgi?id=226547
      this.Oe.enterRestrictedMode(
      /* purgeExistingTasks= */
      !0), this.Oe.enqueueAndForget(() => this.shutdown());
...
class rr {
  ...
  getDocumentsMatchingQuery(t, e, n, s) {
    ...
    return function (t) {
      ...
      const r = this.Mn(e, i);
      return (de(e) || we(e)) && this.Ln(e.limitType, r, s, n) ? this.Fn(t, e) : (C() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.LogLevel.DEBUG && x("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ae(e)), this.On.getDocumentsMatchingQuery(t, e, n).next(t => ( // We merge `previousResults` into `updateResults`, since
  ...
  Fn(t, e) {
    return C() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.LogLevel.DEBUG && x("QueryEngine", "Using full collection scan to execute query:", Ae(e)), this.On.getDocumentsMatchingQuery(t, e, st.min());
  }
...
function _cr() {
  _cr = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t);
    let s = n.In,
        i = n.Qn;
    const r = yield n.persistence.runTransaction("Handle user change", "readonly", t => {
      // Swap out the mutation queue, grabbing the pending mutation batches
      // before and after.
      let r;
      return n.In.getAllMutationBatches(t).next(o => (r = o, s = n.persistence.getMutationQueue(e), // Recreate our LocalDocumentsView using the new
      // MutationQueue.
...
function lr(t, e) {
  ...
  return n.persistence.runTransaction("Apply remote event", "readwrite-primary", t => {
    ...
    e.targetChanges.forEach((e, r) => {
      ...
      const c = e.resumeToken; // Update the resume token if the change includes one.
    ...
    let a = yn(); // HACK: The only reason we allow a null snapshot version is so that we
...
function wr(t, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", t => {
    let s;
    return n.ze.getTargetData(t, e).next(i => i ? ( // This target has been listened to previously, so reuse the
    // previous targetID.
    // TODO(mcg): freshen last accessed date?
    s = i, qs.resolve(s)) : n.ze.allocateTargetId(t).next(i => (s = new ni(e, i, 0
    /* Listen */
    , t.currentSequenceNumber), n.ze.addTargetData(t, s).next(() => s))));
  }).then(t => {
...
function _r2() {
  _r2 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = B(t),
          i = s.Un.get(e),
    ...
    try {
      ...
      if (!Gs(t)) throw t; // All `releaseTarget` does is record the final metadata state for the
...
function _pr() {
  _pr = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = B(t);
    return e.persistence.runTransaction("Synchronize last document change read time", "readonly", t => function (t) {
      const e = Gi(t); // If there are no existing entries, we return SnapshotVersion.min().
...
function Er(_x10, _x11, _x12, _x13) {
...
function _Er() {
  _Er = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    const i = B(t);
    let r = Rn(),
        o = yn(),
        a = In();
    ...
    return i.persistence.runTransaction("Apply bundle documents", "readwrite", t => fr(t, c, o, st.min(), a).next(e => (c.apply(t), e)).next(e => i.ze.removeMatchingKeysForTargetId(t, u.targetId).next(() => i.ze.addMatchingKeys(t, r, u.targetId)).next(() => i.Qn.vn(t, e)).next(() => e)));
  });
  return _Er.apply(this, arguments);
}

function Tr(_x14, _x15) {
...
function _Tr() {
  _Tr = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n = Rn()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = yield wr(t, pe(di(e.bundledQuery))),
          i = B(t);
    return i.persistence.runTransaction("Save named query", "readwrite", t => {
      const r = qn(e.readTime); // Simply save the query itself if it is older than what the SDK already
      // has.
...
class br {
  ...
  getAllMutationBatchesAffectingQuery(t, e) {
    ...
    const r = new Rr(new Rt(i), 0); // Find unique batchIDs referenced by all documents potentially matching the
    // query.
  ...
  te(t) {// No-op since the memory mutation queue does not maintain a separate cache.
  }
...
class Pr {
  ...
  getDocumentsMatchingQuery(t, e, n) {
    let s = yn(); // Documents are ordered by key, so we can use a prefix scan to narrow down
    // the documents we need to match the query against.

    const i = new Rt(e.path.child("")),
...
class $r {
  ...
  static $s(t, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new q(s.error.code, s.error.message))), r ? new $r(t, e, s.state, i) : (k("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
...
class Or {
  ...
  static $s(t, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new q(n.error.code, n.error.message))), i ? new Or(t, n.state, s) : (k("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), null);
  }
...
class Fr {
  ...
  static $s(t, e) {
    ...
    return s ? new Fr(t, i) : (k("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), null);
  }
...
class Mr {
  ...
  static $s(t) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Mr(e.clientId, e.onlineState) : (k("SharedClientState", `Failed to parse online state: ${t}`), null);
  }
...
class Br {
  constructor(t, e, n, s, i) {
    ...
    * limitations under the License.
    */
    (this.persistenceKey), this.qs = this.qs.insert(this.Ls, new Lr()), this.Ws = new RegExp(`^firestore_clients_${r}_([^_]*)$`), this.Gs = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.zs = new RegExp(`^firestore_targets_${r}_(\\d+)$`), this.Hs =
  ...
  start() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      // SharedClientState.
      const t = yield _this9.syncEngine.pn();

      for (const e of t) {
        if (e === _this9.Ls) continue;

        const t = _this9.getItem(Nr(_this9.persistenceKey, e));

        if (t) {
          const n = Fr.$s(e, t);
          n && (_this9.qs = _this9.qs.insert(n.clientId, n));
        }
      }

      _this9.Ys(); // Check if there is an existing online state and call the callback handler
      // if applicable.


      const e = _this9.storage.getItem(_this9.Hs);
      ...
      for (const t of _this9.Ks) _this9.Us(t);

      _this9.Ks = [], // Register a window unload hook to remove the client metadata entry from
  ...
  Us(t) {
    ...
    if (e.storageArea === this.storage) {
      ...
      this.Oe.enqueueRetryable( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        if (_this10.started) {
          if (null !== e.key) if (_this10.Ws.test(e.key)) {
            if (null == e.newValue) {
              const t = _this10.ai(e.key);

              return _this10.ci(t, null);
            }

            {
              const t = _this10.ui(e.key, e.newValue);

              if (t) return _this10.ci(t.clientId, t);
            }
          } else if (_this10.Gs.test(e.key)) {
            if (null !== e.newValue) {
              const t = _this10.hi(e.key, e.newValue);

              if (t) return _this10.li(t);
            }
          } else if (_this10.zs.test(e.key)) {
            if (null !== e.newValue) {
              const t = _this10.fi(e.key, e.newValue);

              if (t) return _this10.di(t);
            }
          } else if (e.key === _this10.Hs) {
            if (null !== e.newValue) {
              const t = _this10.Xs(e.newValue);

              if (t) return _this10.Zs(t);
            }
          } else if (e.key === _this10.Qs) {
            const t = function (t) {
              let e = J.T;
              if (null != t) try {
            ...
            */
            ...
            t !== J.T && _this10.sequenceNumberHandler(t);
          } else if (e.key === _this10.Js) return _this10.syncEngine.wi();
        } else _this10.Ks.push(e);
      }));
    }
  }
  ...
  ei(t, e, n) {
    const s = new $r(this.currentUser, t, e, n),
  ...
  ii(t, e, n) {
    const s = kr(this.persistenceKey, t),
          i = new Or(t, e, n);
    this.setItem(s, i.Os());
  }
  ...
  li(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (t.user.uid === _this11.currentUser.uid) return _this11.syncEngine._i(t.batchId, t.state, t.error);
...
class {
  ...
  Li(t, e, n, s) {
    ...
    const r = {};
    return this.Ui(r, s), this.qi(t, i, r, n).then(t => (x("RestConnection", "Received: ", t), t), e => {
      throw $("RestConnection", `${t} failed with error: `, e, "url: ", i, "request:", n), e;
    });
  }
        ...
        try {
          switch (o.getLastErrorCode()) {
            ...
            case _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.ErrorCode.HTTP_ERROR:
              ...
              if (x("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", o.getResponseText()), n > 0) {
  ...
  ji(t, e) {
    const n = [this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel"],
          s = (0,_firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.createWebChannelTransport)(),
          i = (0,_firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.getStatEventTarget)(),
          r = {
    ...
    this.useFetchStreams && (r.xmlHttpFactory = new _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.FetchXmlHttpFactory({})), this.Ui(r.initMessageHeaders, e), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    const a = s.createWebChannel(o, r); // WebChannel supports sending the first message with the handshake - saving
    ...
    return g(a, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.OPEN, () => {
      u || x("Connection", "WebChannel transport opened.");
    }), g(a, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.CLOSE, () => {
      u || (u = !0, x("Connection", "WebChannel transport closed"), m.$i());
    }), g(a, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.ERROR, t => {
      u || (u = !0, $("Connection", "WebChannel transport errored:", t), m.$i(new q(U.UNAVAILABLE, "The operation could not be completed")));
    }), g(a, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.MESSAGE, t => {
      var e;
      ...
      if (!u) {
        ...
        if (i) {
          ...
          */
          ...
          void 0 === e && (e = U.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), // Mark closed so no further events are propagated
          u = !0, m.$i(new q(e, n)), a.close();
        } else x("Connection", "WebChannel received:", n), m.Oi(n);
      }
    }), g(i, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.Event.STAT_EVENT, t => {
      t.stat === _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.Stat.PROXY ? x("Connection", "Detected buffering proxy") : t.stat === _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.Stat.NOPROXY && x("Connection", "Detected no buffering proxy");
    }), setTimeout(() => {
...
class Jr {
  ...
  Xi(t) {
    ...
    const e = Math.floor(this.zi + this.Zi()),
          n = Math.max(0, Date.now() - this.Ji),
          s = Math.max(0, e - n); // Guard against lastAttemptTime being in the future due to a clock change.

    s > 0 && x("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.zi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.Hi = this.Oe.enqueueAfterDelay(this.timerId, s, () => (this.Ji = Date.now(), t())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
class Yr {
  ...
  stop() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this12.ar() && (yield _this12.close(0
      /* Initial */
      ));
    })();
  }
  ...
  dr() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this13.cr()) // When timing out an idle stream there's no reason to force the stream into backoff when
  ...
  close(t, e) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this14._r(), _this14.rr.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
      // underlying stream), guaranteeing they won't execute.
      _this14.sr++, 3
      /* Error */
      !== t ? // If this is an intentional close ensure we don't delay our next connection attempt.
      _this14.rr.reset() : e && e.code === U.RESOURCE_EXHAUSTED ? ( // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
      k(e.toString()), k("Using maximum backoff delay to prevent overloading the backend."), _this14.rr.Yi()) : e && e.code === U.UNAUTHENTICATED && // "unauthenticated" error means the token was rejected. Try force refreshing it in case it
      // just expired.
      _this14.credentialsProvider.invalidateToken(), // Clean up the underlying stream because we are no longer interested in events.
      null !== _this14.stream && (_this14.mr(), _this14.stream.close(), _this14.stream = null), // This state must be assigned before calling onClose() to allow the callback to
      // inhibit backoff or otherwise manipulate the state in its non-started state.
      _this14.state = t, // Notify the listener that the stream closed.
      yield _this14.listener.Ci(e);
    })();
  }
  /**
  ...
  auth() {
    ...
    this.credentialsProvider.getToken().then(t => {
      ...
      this.sr === e && // Normally we'd have to schedule the callback on the AsyncQueue.
  ...
  ur() {
    ...
    this.state = 4
    /* Backoff */
    , this.rr.Xi( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this15.state = 0
      /* Initial */
      , _this15.start();
    }));
  ...
  gr(t) {
    return e => {
      this.Oe.enqueueAndForget(() => this.sr === t ? e() : (x("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
...
class Zr extends Yr {
  ...
  onMessage(t) {
    ...
    M(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Rr) {
      ...
      this.rr.reset();
      const e = ss(t.writeResults, t.commitTime),
            n = qn(t.commitTime);
...
class to extends class {} {
  ...
  Li(t, e, n) {
    return this.Cr(), this.credentials.getToken().then(s => this.nr.Li(t, e, n, s)).catch(t => {
      throw "FirebaseError" === t.name ? (t.code === U.UNAUTHENTICATED && this.credentials.invalidateToken(), t) : new q(U.UNKNOWN, t.toString());
    });
  }
...
class eo {
  ...
  Or() {
    ...
    /* OnlineStateTimeout */
    , 1e4, () => (this.kr = null, this.Mr("Backend didn't respond within 10 seconds."), this.Fr("Offline"
    /* Offline */
    ), Promise.resolve())));
  }
  /**
  ...
  Lr(t) {
    ...
    /* Unknown */
    ) : (this.Nr++, this.Nr >= 1 && (this.Br(), this.Mr(`Connection failed 1 times. Most recent error: ${t.toString()}`), this.Fr("Offline"
    /* Offline */
    )));
  }
  /**
...
class no {
  ...
  e, n, s, i) {
    ...
    this.jr = [], this.Qr = i, this.Qr.Ei(t => {
      n.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        // Porting Note: Unlike iOS, `restartNetwork()` is called even when the
        // network becomes unreachable as we don't have any other way to tear
        // down our streams.
        lo(_this16) && (x("RemoteStore", "Restarting streams for network reachability change."), yield function () {
          var _ref9 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
            const e = B(t);
            e.Kr.add(4
            /* ConnectivityChange */
            ), yield io(e), e.Wr.set("Unknown"
            /* Unknown */
            ), e.Kr.delete(4
            /* ConnectivityChange */
            ), yield so(e);
...
function _so() {
  _so = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    if (lo(t)) for (const e of t.jr) yield e(
    /* enabled= */
    !0);
  });
  return _so.apply(this, arguments);
...
function _io() {
  _io = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    for (const e of t.jr) yield e(
    /* enabled= */
    !1);
  });
  return _io.apply(this, arguments);
...
function _wo() {
  _wo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    t.qr.forEach((e, n) => {
      ao(t, e);
    });
  });
...
function _o(_x20, _x21) {
  return _o2.apply(this, arguments);
}

function _o2() {
  _o2 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
...
function _mo() {
  _mo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    ...
    === e.state && e.cause) // There was an error on a target, don't wait for a consistent snapshot
      ...
      try {
        yield (
          ...
          function () {
            var _ref41 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
              const n = e.cause;

              for (const s of e.targetIds) // A watched target might have been removed already.
              t.qr.has(s) && (yield t.remoteSyncer.rejectListen(s, n), t.qr.delete(s), t.Gr.removeTarget(s));
            });
        ...
        x("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), yield go(t, n);
      } else if (e instanceof Sn ? t.Gr.rt(e) : e instanceof Dn ? t.Gr.ft(e) : t.Gr.ct(e), !n.isEqual(st.min())) try {
      const e = yield hr(t.localStore);
      ...
      yield (
        ...
        */
        function (t, e) {
          const n = t.Gr._t(e); // Update in-memory resume tokens. LocalStore will update the
          // persistent view of these when applying the completed RemoteEvent.


          return n.targetChanges.forEach((n, s) => {
            if (n.resumeToken.approximateByteSize() > 0) {
              const i = t.qr.get(s); // A watched target might have been removed already.
      ...
      x("RemoteStore", "Failed to raise snapshot:", e), yield go(t, e);
    }
  });
  return _mo.apply(this, arguments);
}

function go(_x25, _x26, _x27) {
...
function _go() {
  _go = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    if (!Gs(e)) throw e;
    t.Kr.add(1
    /* IndexedDbFailed */
    ), // Disable network and raise offline snapshots
    yield io(t), t.Wr.set("Offline"
    /* Offline */
    ), n || ( // Use a simple read operation to determine if IndexedDB recovered.
    // Ideally, we would expose a health check directly on SimpleDb, but
    // RemoteStore only has access to persistence through LocalStore.
    n = () => hr(t.localStore)), // Probe IndexedDB periodically and re-enable network
    t.asyncQueue.enqueueRetryable( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      x("RemoteStore", "Retrying IndexedDB access"), yield n(), t.Kr.delete(1
      /* IndexedDbFailed */
      ), yield so(t);
    }));
  });
...
function _po() {
  _po = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = B(t),
          n = Do(e);
    let s = e.Ur.length > 0 ? e.Ur[e.Ur.length - 1].batchId : -1;

    for (; Eo(e);) try {
      const t = yield dr(e.localStore, s);
...
function _Ro() {
  _Ro = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    Do(t).Sr();
  });
  return _Ro.apply(this, arguments);
}
...
function _bo() {
  _bo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = Do(t); // Send the write pipeline now that the stream is established.
...
function Po(_x31, _x32, _x33) {
  return _Po.apply(this, arguments);
}

function _Po() {
  _Po = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = t.Ur.shift(),
          i = ei.from(s, e, n);
    yield yo(t, () => t.remoteSyncer.applySuccessfulWrite(i)), // It's possible that with the completion of this mutation another
    // slot has freed up.
    yield po(t);
  });
  return _Po.apply(this, arguments);
...
function _vo() {
  _vo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    // If the write stream closed after the write handshake completes, a write
    // operation failed and we fail the pending operation.
    e && Do(t).br && ( // This error affects the actual write.
    yield function () {
      var _ref43 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
        // Only handle permanent errors here. If it's transient, just let the retry
        // logic kick in.
        if (n = e.code, hn(n) && n !== U.ABORTED) {
          // This was a permanent error, the request itself was the problem
          // so it's not going to succeed if we resend it.
          const n = t.Ur.shift(); // In this case it's also unlikely that the server itself is melting
          // down -- this was just a bad request so inhibit backoff on the next
          // restart.

          Do(t).hr(), yield yo(t, () => t.remoteSyncer.rejectFailedWrite(n.batchId, e)), // It's possible that with the completion of this mutation
...
function _Vo() {
  _Vo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    ...
    e ? (n.Kr.delete(2
    /* IsSecondary */
    ), yield so(n)) : e || (n.Kr.add(2
    /* IsSecondary */
    ), yield io(n), n.Wr.set("Unknown"
    /* Unknown */
    ));
  });
  return _Vo.apply(this, arguments);
...
function So(t) {
  ...
  */
  (t.datastore, t.asyncQueue, {
    ...
    var _ref10 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
      e ? (t.zr.hr(), ho(t) ? uo(t) : t.Wr.set("Unknown"
      /* Unknown */
      )) : (yield t.zr.stop(), fo(t));
    });
...
function Do(t) {
  ...
  t.Hr = function (t, e, n) {
    ...
    var _ref11 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
      e ? (t.Hr.hr(), // This will start the write stream if necessary.
      yield po(t)) : (yield t.Hr.stop(), t.Ur.length > 0 && (x("RemoteStore", `Stopping write stream with ${t.Ur.length} pending writes`), t.Ur = []));
    });
...
class xo {
  ...
  constructor(t) {
    ...
    this.comparator = t ? (e, n) => t(e, n) || Rt.comparator(e.key, n.key) : (t, e) => Rt.comparator(t.key, e.key), this.keyedMap = En(), this.sortedSet = new fn(this.comparator);
  }
  /**
...
function Mo(_x40, _x41) {
  return _Mo.apply(this, arguments);
}

function _Mo() {
  _Mo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t),
          s = e.query;
    let i = !1,
        r = n.queries.get(s);
    if (r || (i = !0, r = new Oo()), i) try {
      r.Xr = yield n.onListen(s);
    } catch (t) {
...
function Lo(_x42, _x43) {
  return _Lo.apply(this, arguments);
}

function _Lo() {
  _Lo = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t),
          s = e.query;
    let i = !1;
...
class Wo {
  ...
  complete() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const t = yield Er(_this17.localStore, new Qo(_this17.N), _this17.documents, _this17.lo.id),
            e = _this17.wo(_this17.documents);

      for (const t of _this17.queries) yield Tr(_this17.localStore, t, e.get(t.name));

      return _this17.progress.taskState = "Success", new nr(Object.assign({}, _this17.progress), t);
    })();
  }
...
class Jo {
    ...
    if (t.inorderTraversal((t, e) => {
      ...
      if (u && h) {
        u.data.isEqual(h.data) ? l !== f && (n.track({
          ...
          ,
          doc: h
        }), d = !0, (a && this.po(h, a) > 0 || c && this.po(h, c) < 0) && ( // This doc moved from inside the limit to outside the limit.
  ...
  bo(t) {
    t && (t.addedDocuments.forEach(t => this._o = this._o.add(t)), t.modifiedDocuments.forEach(t => {}), t.removedDocuments.forEach(t => this._o = this._o.delete(t)), this.current = t.current);
  }
...
class Zo {
  ...
  s, i, r) {
    this.localStore = t, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.No = {}, this.xo = new qi(t => Ie(t), Te), this.ko = new Map(),
    /**
...
function _ta() {
  _ta = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = Sa(t);
    let s, i;
    const r = n.xo.get(e);
    if (r) // PORTING NOTE: With Multi-Tab Web, it is possible that a query view
      ...
      const t = yield wr(n.localStore, pe(e)),
            r = n.sharedClientState.addLocalQueryTarget(t.targetId);
      s = t.targetId, i = yield ea(n, e, s, "current" === r), n.isPrimaryClient && ro(n.remoteStore, t);
    }
    return i;
  });
  return _ta.apply(this, arguments);
...
function ea(_x46, _x47, _x48, _x49) {
...
function _ea() {
  _ea = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    // PORTING NOTE: On Web only, we inject the code that registers new Limbo
    // targets based on view changes. This allows us to only depend on Limbo
    // changes when user code includes queries.
    t.Ko = (e, n, s) => function () {
      var _ref44 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
        let i = e.view.Io(n);
        i.Ln && ( // The query has a limit and some docs were removed, so we need
        // to re-run the query against the local store to make sure we
        // didn't lose any good docs that had been past the limit.
        i = yield mr(t.localStore, e.query,
        /* usePreviousResults= */
        !1).then(({
          documents: t
        }) => e.view.Io(t, i)));
    ...
    const i = yield mr(t.localStore, e,
    /* usePreviousResults= */
    !0),
          r = new Jo(e, i.Gn),
          o = r.Io(i.documents),
...
function _na() {
  _na = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t),
          s = n.xo.get(e),
          i = n.ko.get(s.targetId);
    if (i.length > 1) return n.ko.set(s.targetId, i.filter(t => !Te(t, e))), void n.xo.delete(e); // No other queries are mapped to the target, clean up the query and the target.

    if (n.isPrimaryClient) {
      // We need to remove the local query target first to allow us to verify
      // whether any other client is still interested in this target.
      n.sharedClientState.removeLocalQueryTarget(s.targetId);
      n.sharedClientState.isActiveQueryTarget(s.targetId) || (yield _r(n.localStore, s.targetId,
      /*keepPersistedTargetData=*/
      !1).then(() => {
        n.sharedClientState.clearQueryState(s.targetId), oo(n.remoteStore, s.targetId), fa(n, s.targetId);
      }).catch($i));
    } else fa(n, s.targetId), yield _r(n.localStore, s.targetId,
    /*keepPersistedTargetData=*/
    !0);
  });
  return _na.apply(this, arguments);
...
function _sa() {
  _sa = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = Da(t);
    ...
    try {
      ...
      * it.
      */
      (s, t.batchId, n), yield ga(s, t.changes), yield po(s.remoteStore);
    } catch (t) {
...
function _ia() {
  _ia = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t);

    try {
      const t = yield lr(n.localStore, e); // Update `receivedDocument` as appropriate for any limbo targets.
...
function ra(t, e, n) {
  const s = B(t); // If we are the secondary client, we explicitly ignore the remote store's
...
function oa(_x57, _x58, _x59) {
  return _oa.apply(this, arguments);
}

function _oa() {
  _oa = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = B(t); // PORTING NOTE: Multi-tab only.
    ...
    if (r) {
      ...
      /* targetMismatches= */
      new _n(Z), t, n);
      yield ia(s, i), // Since this query failed, we won't want to manually unlisten to it.
      // We only remove it from bookkeeping after we successfully applied the
      // RemoteEvent. If `applyRemoteEvent()` throws, we want to re-listen to
      // this query when the RemoteStore restarts the Watch stream, which should
      // re-trigger the target failure.
      s.Oo = s.Oo.remove(r), s.Fo.delete(e), ma(s);
    } else yield _r(s.localStore, e,
    /* keepPersistedTargetData */
    !1).then(() => fa(s, e, n)).catch($i);
  });
  return _oa.apply(this, arguments);
}

function aa(_x60, _x61) {
  return _aa.apply(this, arguments);
}

function _aa() {
  _aa = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t),
          s = e.batch.batchId;

    try {
      const t = yield ur(n.localStore, e); // The local store may or may not be able to apply the write result and
      ...
      la(n, s,
      /*error=*/
      null), ha(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), yield ga(n, t);
    } catch (t) {
      yield $i(t);
    }
  });
...
function _ca() {
  _ca = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = B(t);
    ...
    try {
      ...
      */
      ...
      la(s, e, n), ha(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), yield ga(s, t);
    } catch (n) {
      yield $i(n);
    }
  });
...
function _ua() {
  _ua = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t);
...
function la(t, e, n) {
  const s = B(t);
  let i = s.Lo[s.currentUser.toKey()]; // NOTE: Mutations restored from persistence won't have callbacks, so it's
...
function wa(t, e, n) {
  for (const s of n) if (s instanceof zo) t.Mo.addReference(s.key, e), _a(t, s);else if (s instanceof Ho) {
    ...
    t.Mo.containsKey(s.key) || // We removed the last reference for this key
    da(t, s.key);
  } else F();
}
...
function ma(t) {
  for (; t.$o.size > 0 && t.Oo.size < t.maxConcurrentLimboResolutions;) {
    ...
    t.$o.delete(e);
    const n = new Rt(ct.fromString(e)),
          s = t.Uo.next();
    t.Fo.set(s, new Xo(n)), t.Oo = t.Oo.insert(n, s), ro(t.remoteStore, new ni(pe(fe(n.path)), s, 2
    /* LimboResolution */
    , J.T));
  }
}

function ga(_x67, _x68, _x69) {
  return _ga.apply(this, arguments);
}

function _ga() {
  _ga = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = B(t),
          i = [],
          r = [],
          o = [];
    ...
    }), yield Promise.all(o), s.No.Tr(i), yield function () {
      var _ref45 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
        const n = B(t);

        try {
          yield n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", t => qs.forEach(e, e => qs.forEach(e.Nn, s => n.persistence.referenceDelegate.addReference(t, e.targetId, s)).next(() => qs.forEach(e.xn, s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))));
        } catch (t) {
          if (!Gs(t)) throw t; // If `notifyLocalViewChanges` fails, we did not advance the sequence
...
function ya(_x70, _x71) {
  return _ya.apply(this, arguments);
}

function _ya() {
  _ya = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t);

    if (!n.currentUser.isEqual(e)) {
      x("SyncEngine", "User change. New user:", e.toKey());
      const t = yield cr(n.localStore, e);
      ...
      n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), yield ga(n, t.Wn);
    }
  });
  return _ya.apply(this, arguments);
}
...
function _Ea() {
  _Ea = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = B(t),
          s = yield mr(n.localStore, e.query,
    /* usePreviousResults= */
    !0),
          i = e.view.So(s);
...
function _Ta() {
  _Ta = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = B(t);
...
function Ia(_x75, _x76, _x77, _x78) {
  return _Ia.apply(this, arguments);
}
...
function _Ia() {
  _Ia = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    const i = B(t),
    ...
    yield po(i.remoteStore) : "acknowledged" === n || "rejected" === n ? ( // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    la(i, e, s || null), ha(i, e), function (t, e) {
      B(B(t).In).te(e);
    } // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : F(), yield ga(i, r)) : // A throttled tab may not have seen the mutation before it was completed
  ...
  _Aa = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    ...
    if (Sa(n), Da(n), !0 === e && !0 !== n.qo) {
      ...
      const t = n.sharedClientState.getAllActiveQueryTargets(),
            e = yield Ra(n, t.toArray());
      n.qo = !0, yield Vo(n.remoteStore, !0);
      ...
      n.ko.forEach((s, i) => {
        n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then(() => (fa(n, i), _r(n.localStore, i,
        /*keepPersistedTargetData=*/
        !0))), oo(n.remoteStore, i);
      }), yield e, yield Ra(n, t), // PORTING NOTE: Multi-Tab only.
      function (t) {
        const e = B(t);
        e.Fo.forEach((t, n) => {
          oo(e.remoteStore, n);
      ...
      */
      // PORTING NOTE: Multi-Tab only.
      (n), n.qo = !1, yield Vo(n.remoteStore, !1);
    }
  });
  return _Aa.apply(this, arguments);
}

function Ra(_x81, _x82, _x83) {
...
function _Ra() {
  _Ra = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = B(t),
          i = [],
          r = [];
    ...
    for (const t of e) {
      ...
      if (n && 0 !== n.length) {
        ...
        e = yield wr(s.localStore, pe(n[0]));
        ...
        const n = yield gr(s.localStore, t);
        e = yield wr(s.localStore, n), yield ea(s, ba(n), t,
        /*current=*/
        !1);
      }
...
function va(_x84, _x85, _x86, _x87) {
...
function _va() {
  _va = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    const i = B(t);
      ...
      case "not-current":
        {
          const t = yield yr(i.localStore),
                s = vn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
          yield ga(i, t, s);
          break;
        }

      case "rejected":
        yield _r(i.localStore, e,
        /* keepPersistedTargetData */
        !0), fa(i, e, s);
        break;
...
function Va(_x88, _x89, _x90) {
  return _Va.apply(this, arguments);
}

function _Va() {
  _Va = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = Sa(t);
    ...
    if (s.qo) {
      for (const t of e) {
        ...
        const e = yield gr(s.localStore, t),
              n = yield wr(s.localStore, e);
        yield ea(s, ba(e), n.targetId,
        /*current=*/
        !1), ro(s.remoteStore, n);
      }

      for (const t of n) // Check that the target is still active since the target might have been
      // removed if it has been rejected by the backend.
      s.ko.has(t) && ( // Release queries that are still active.
      yield _r(s.localStore, t,
      /* keepPersistedTargetData */
      !1).then(() => {
...
function Ca(t, e, n) {
  const s = B(t); // eslint-disable-next-line @typescript-eslint/no-floating-promises

  (function () {
    var _ref12 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
      try {
        ...
        */
        ...
        for (; r;) {
          const t = yield i.fo(r);
          t && n._updateProgress(t), r = yield e.Qo();
        }
...
class Na {
  ...
  initialize(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this18.N = Hr(t.databaseInfo.databaseId), _this18.sharedClientState = _this18.Wo(t), _this18.persistence = _this18.Go(t), yield _this18.persistence.start(), _this18.gcScheduler = _this18.zo(t), _this18.localStore = _this18.Ho(t);
    })();
  }
...
class xa extends Na {
  ...
  initialize(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _superprop_getInitialize().call(_this20, t), yield pr(_this20.localStore), yield _this20.Jo.initialize(_this20, t), // Enqueue writes from a previous session
      yield Da(_this20.Jo.syncEngine), yield po(_this20.Jo.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      yield _this20.persistence.nn(() => (_this20.gcScheduler && !_this20.gcScheduler.started && _this20.gcScheduler.start(_this20.localStore), Promise.resolve()));
    })();
  }
  ...
  Go(t) {
    const e = er(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey),
...
class ka extends xa {
  constructor(t, e) {
    super(t, e,
    /* forceOwnership= */
    !1), this.Jo = t, this.cacheSizeBytes = e, this.synchronizeTabs = !0;
  }
  ...
  initialize(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const e = _this21.Jo.syncEngine;
      _this21.sharedClientState instanceof Br && (_this21.sharedClientState.syncEngine = {
        _i: Ia.bind(null, e),
        mi: va.bind(null, e),
        gi: Va.bind(null, e),
        pn: Pa.bind(null, e),
      ...
      // set it after localStore / remoteStore are started.
      yield _this21.persistence.nn( /*#__PURE__*/function () {
        var _ref13 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
          yield Aa(_this21.Jo.syncEngine, t), _this21.gcScheduler && (t && !_this21.gcScheduler.started ? _this21.gcScheduler.start(_this21.localStore) : t || _this21.gcScheduler.stop());
        });
...
class $a {
  initialize(t, e) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      /* startAsPrimary=*/
      !t.synchronizeTabs), _this22.sharedClientState.onlineStateHandler = t => ra(_this22.syncEngine, t, 1
      /* SharedClientState */
      ), _this22.remoteStore.remoteSyncer.handleCredentialChange = ya.bind(null, _this22.syncEngine), yield Vo(_this22.remoteStore, _this22.syncEngine.isPrimaryClient));
    })();
  }
  ...
  createDatastore(t) {
    const e = Hr(t.databaseInfo.databaseId),
  ...
  createRemoteStore(t) {
    return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => ra(this.syncEngine, t, 0
    /* RemoteStore */
  ...
  terminate() {
    return function () {
      var _ref14 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        const e = B(t);
        x("RemoteStore", "RemoteStore shutting down."), e.Kr.add(5
        /* Shutdown */
        ), yield io(e), e.Qr.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
class Ma {
  ...
  Qo() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return yield _this24.getMetadata(), _this24.ea();
    })();
  }
  /**
  ...
  ea() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const t = yield _this25.na();
      if (null === t) return null;

      const e = _this25.ta.decode(t),
            n = Number(e);

      isNaN(n) && _this25.sa(`length string (${e}) is not valid number`);
      const s = yield _this25.ia(n);
  ...
  na() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const t = _this26.ra(); // Broke out of the loop because underlying stream is closed, but still
      // cannot find an open bracket.


      t < 0 && _this26.sa("Reached the end of bundle when a length string is expected.");
  ...
  ia(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      for (; _this27.buffer.length < t;) {
        (yield _this27.oa()) && _this27.sa("Reached the end of bundle when more is expected.");
      }

      const e = _this27.ta.decode(_this27.buffer.slice(0, t)); // Update the internal buffer to drop the read json string.
...
class La {
  ...
  lookup(t) {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this29.ensureCommitNotCalled(), _this29.mutations.length > 0) throw new q(U.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
      const e = yield function () {
        var _ref15 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
          const n = B(t),
                s = Hn(n.N) + "/documents",
                i = {
            documents: e.map(t => Qn(n.N, t))
          },
                r = yield n.Ki("BatchGetDocuments", s, i),
                o = new Map();
          r.forEach(t => {
            const e = Zn(n.N, t);
  ...
  commit() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      t.forEach((t, e) => {
        ...
        _this30.mutations.push(new on(n, _this30.precondition(n)));
      }), yield function () {
        var _ref16 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
          const n = B(t),
                s = Hn(n.N) + "/documents",
                i = {
            writes: e.map(t => es(n.N, t))
          };
          yield n.Li("Commit", s, i);
        });
...
class Ba {
  ...
  ca() {
    ...
    this.rr.Xi( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const t = new La(_this31.datastore),
            e = _this31.ua(t);
  ...
  ha(t) {
    this.aa > 0 && this.la(t) ? (this.aa -= 1, this.asyncQueue.enqueueAndForget(() => (this.ca(), Promise.resolve()))) : this.deferred.reject(t);
  }
...
class Ua {
  ...
  e, n) {
    ...
    this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = V.UNAUTHENTICATED, this.clientId = X.I(), this.credentialListener = () => Promise.resolve(), this.credentials.start(e, /*#__PURE__*/function () {
      var _ref18 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        x("FirestoreClient", "Received user=", t.uid), yield _this32.credentialListener(t), _this32.user = t;
      });
  ...
  getConfiguration() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return {
        ...
        credentials: _this33.credentials,
  ...
  terminate() {
    ...
    const t = new K();
    return this.asyncQueue.enqueueAndForgetEvenWhileRestricted( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        // tokens.
        _this34.credentials.shutdown(), t.resolve();
      } catch (e) {
...
function qa(_x101, _x102) {
  return _qa.apply(this, arguments);
}

function _qa() {
  _qa = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    ...
    t.setCredentialChangeListener( /*#__PURE__*/function () {
      var _ref46 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        s.isEqual(t) || (yield cr(e.localStore, t), s = t);
      });
...
function Ka(_x103, _x104) {
  return _Ka.apply(this, arguments);
}

function _Ka() {
  _Ka = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    ...
    t.setCredentialChangeListener(t => function () {
      var _ref47 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
        const n = B(t);
        n.asyncQueue.verifyOperationInProgress(), x("RemoteStore", "RemoteStore received new credentials");
        const s = lo(n); // Tear down and re-create our network streams. This will ensure we get a
        // fresh auth token for the new user and re-fill the write pipeline with
        // new mutations from the LocalStore (since mutations are per-user).

        n.Kr.add(3
        /* CredentialChange */
        ), yield io(n), s && // Don't set the network status to Unknown if we are offline.
        n.Wr.set("Unknown"
        /* Unknown */
        ), yield n.remoteSyncer.handleCredentialChange(e), n.Kr.delete(3
        /* CredentialChange */
        ), yield so(n);
      });
...
function _ja() {
  _ja = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    return t.offlineComponents || (x("FirestoreClient", "Using default OfflineComponentProvider"), yield qa(t, new Na())), t.offlineComponents;
  });
  return _ja.apply(this, arguments);
}
...
function _Qa() {
  _Qa = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    return t.onlineComponents || (x("FirestoreClient", "Using default OnlineComponentProvider"), yield Ka(t, new $a())), t.onlineComponents;
  });
  return _Qa.apply(this, arguments);
}
...
function _Ja() {
  _Ja = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = yield Qa(t),
          n = e.eventManager;
    return n.onListen = ta.bind(null, e.syncEngine), n.onUnlisten = na.bind(null, e.syncEngine), n;
  });
  return _Ja.apply(this, arguments);
}

function Ya(t) {
  return t.asyncQueue.enqueue( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    const e = yield Wa(t),
          n = yield za(t);
...
function Xa(t) {
  return t.asyncQueue.enqueue( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    return e.setNetworkEnabled(!1), function () {
      var _ref22 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        const e = B(t);
        e.Kr.add(0
        /* UserDisabled */
        ), yield io(e), // Set the OnlineState to Offline so get()s return from cache, etc.
        e.Wr.set("Offline"
        /* Offline */
        );
      });
...
function Za(t, e) {
  const n = new K();
  return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    return function () {
      var _ref24 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
        try {
...
function ec(t, e) {
  ...
  return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    return function () {
      var _ref27 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
        try {
          const s = yield mr(t, e,
          /* usePreviousResults= */
          !0),
                i = new Jo(e, s.Gn),
                r = i.Io(s.documents),
...
function sc(t, e) {
  ...
  return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    n.Xo(), t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return function (t, e) {
        B(t).Zr.delete(e);
      }(yield Ja(t), n);
    }));
...
function rc(t, e, n, s) {
  ...
  */
  ...
  t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    Ca(yield Ha(t), i, s);
  }));
}
    ...
    this._settings = new gc(t), void 0 !== t.credentials && (this._credentials = function (t) {
      ...
      switch (t.type) {
        case "gapi":
          ...
          return M(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new H(e, t.sessionIndex || "0", t.iamToken || null);
...
function Ac(t, e, ...n) {
  if (t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t), hc("collection", "path", e), t instanceof yc) {
    const s = ct.fromString(e, ...n);
    return dc(s), new Ic(t,
    /* converter= */
    null, s);
  }
...
function Pc(t, e) {
  return t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t), e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e), (t instanceof Ec || t instanceof Ic) && (e instanceof Ec || e instanceof Ic) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter;
}
/**
...
function vc(t, e) {
  return t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t), e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e), t instanceof Tc && e instanceof Tc && t.firestore === e.firestore && Te(t._query, e._query) && t.converter === e.converter;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class Vc {
  ...
  enqueue(t) {
    ...
    const e = new K();
    return this.Ia(() => this.wa && this.ya ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  ...
  Aa() {
    ...
    return (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (0 !== _this35.da.length) {
        try {
          yield _this35.da[0](), _this35.da.shift(), _this35.rr.reset();
        } catch (t) {
          if (!Gs(t)) throw t; // Failure will be handled by AsyncQueue

          x("AsyncQueue", "Operation failed with retryable error: " + t);
        }

        _this35.da.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  Ia(t) {
    const e = this.fa.then(() => (this.ga = !0, t().catch(t => {
      this.ma = t, this.ga = !1; // Re-throw the error so that this.tail becomes a rejected Promise and
  ...
  va(t) {
    ...
    return this.ba().then(() => {
      ...
      for (const e of this._a) if (e.skipDelay(), "all"
      /* All */
      !== t && e.timerId === t) break;
...
function kc(e = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__.getApp)()) {
...
function Lc(t, e, n) {
  ...
  return t.asyncQueue.enqueue( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    try {
      yield qa(t, n), yield Ka(t, e), s.resolve();
    } catch (t) {
      if (!
      /**
...
function Bc(t) {
  ...
  const e = new K();
  return t._queue.enqueueAndForgetEvenWhileRestricted( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    try {
      yield function () {
        var _ref36 = (0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
...
function ou(t, e, n, s, i, r = {}) {
  const o = t.Ba(r.merge || r.mergeFields ? 2
  /* MergeSet */
  : 0
  /* Set */
  , e, n, i);
...
class au extends Yc {
  _toFieldTransform(t) {
    ...
    !== t.Da) throw 1
    /* Update */
    === t.Da ? t.Fa(`${this._methodName}() can only appear at the top level of your update data`) : t.Fa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`); // No transform to add for a delete, but we need to add it to our
...
function du(t, e, n, s) {
  ...
  const r = [],
        o = Lt.empty();
  rt(s, (t, s) => {
    const a = Iu(e, t, n); // For Compat types, we have to "extract" the underlying types before
...
function wu(t, e, n, s, i, r) {
  ...
  for (let t = a.length - 1; t >= 0; --t) if (!Ru(u, a[t])) {
    ...
    const s = o.$a(e);
    if (n instanceof au) // Add it to the field mask, but don't add anything to updateData.
      u.push(e);else {
      const t = mu(n, s);
...
function mu(t, e) {
  ...
  // from firestore-exp.
  t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t))) return pu("Unsupported field value:", e, t), gu(t, e);
...
function Eu(t, e, n) {
  ...
  // FieldPath.
  e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) instanceof zc) return e._internalPath;
...
function Au(t, e, n, s, i) {
  ...
  let c = "";
  return (r || o) && (c += " (found", r && (c += ` in field ${s}`), o && (c += ` in document ${i}`), c += ")"), new q(U.INVALID_ARGUMENT, a + t + c);
}
  ...
  _apply(t) {
    const e = ru(t.firestore),
      ...
      if (i.isKeyField()) {
        ...
        /* ARRAY_CONTAINS_ANY */
        === r) throw new q(U.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
...
function Ju(t, e, n, s) {
  if (n[0] = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(n[0]), n[0] instanceof bu) return function (t, e, n, s, i) {
...
class th {
  ...
  convertDocumentKey(t, e) {
    ...
    M(ys(n));
    const s = new cc(n.get(1), n.get(3)),
...
class sh {
  ...
  update(t, e, n, ...s) {
    ...
    const i = ih(t, this._firestore); // For Compat types, we have to "extract" the underlying types before
    // performing validation.

    let r;
    return r = "string" == typeof (e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) || e instanceof zc ? wu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : du(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, Qe.exists(!0))), this;
  }
  /**
...
function ih(t, e) {
  if ((t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t)).firestore !== e) throw new q(U.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
  return t;
}
/**
 * @license
...
function dh(t, e, n, ...s) {
  ...
  const i = _c(t.firestore, Nc),
        r = ru(i);

  let o;
  o = "string" == typeof ( // For Compat types, we have to "extract" the underlying types before
  // performing validation.
  e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) || e instanceof zc ? wu(r, "updateDoc", t._key, e, n, s) : du(r, "updateDoc", t._key, e);
...
function mh(t, ...e) {
  ...
  return function (t, e, n, s) {
    const i = new Fa(s),
          r = new Ko(e, i, n);
    return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return Mo(yield Ja(t), r);
    })), () => {
      i.Xo(), t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_Users_applore_Documents_projects_firconnect_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        return Lo(yield Ja(t), r);
      }));
    };
  }($c(u), h, a, c);
}
...
class Eh extends class {
  ...
  update(t, e, n, ...s) {
    ...
    let r;
    return r = "string" == typeof (e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) || e instanceof zc ? wu(this._dataReader, "Transaction.update", i._key, e, n, s) : du(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  /**
   * Deletes the document referred to by the provided {@link DocumentReference}.
   *
...
/* PUBLIC */
)), (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__.registerVersion)("@firebase/firestore", "3.0.2", Vh);
